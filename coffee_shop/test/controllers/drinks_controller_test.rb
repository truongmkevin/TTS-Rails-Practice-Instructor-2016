...
class DrinksControllerTest < ActionController::TestCase
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post :create, drink: { cost: @drink.cost, country: @drink.country, image: @drink.image, name: @drink.name, roast_type: @drink.roast_type }
    end
  ...
  test "should update drink" do
    patch :update, id: @drink, drink: { cost: @drink.cost, country: @drink.country, image: @drink.image, name: @drink.name, roast_type: @drink.roast_type }
    assert_redirected_to drink_path(assigns(:drink))
  end
